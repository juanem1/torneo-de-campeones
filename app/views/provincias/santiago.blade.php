	...
	<nav>
		<ul id="mainmenu">
			...
			<li>
				...
				<ul>
					<li><a href="{{ url('santiago/premier-league/equipos') }}"><span>Equipos</span></a></li>
					<li><a href="{{ url('santiago/premier-league/fixture') }}"><span>Fixture</span></a></li>
					<li><a href="{{ url('santiago/premier-league/posiciones') }}"><span>Posiciones</span></a></li>
				</ul>
			</li>
			<li>
				<a href="#"><span>Serie B</span></a>
				<ul>
					<li><a href="{{ url('santiago/serie-b/equipos') }}"><span>Equipos</span></a></li>
					<li><a href="{{ url('santiago/serie-b/fixture') }}"><span>Fixture</span></a></li>
					<li><a href="{{ url('santiago/serie-b/posiciones') }}"><span>Posiciones</span></a></li>
				</ul>
			</li>
			<li>
				<a href="#"><span>Serie C</span></a>
				<ul>
					<li><a href="{{ url('santiago/serie-c/equipos') }}"><span>Equipos</span></a></li>
					<li><a href="{{ url('santiago/serie-c/fixture') }}"><span>Fixture</span></a></li>
					<li><a href="{{ url('santiago/serie-c/posiciones') }}"><span>Posiciones</span></a></li>
				</ul>
			</li>
		</ul>
	</nav>
...
@section('content')
	<!-- PAGE TITLE -->
	<div class="page-title">Santiago</div>
