	...
	<nav>
		<ul id="mainmenu">
			...
			<li>
				...
				<ul>
					<li><a href="{{ url('buenos-aires/premier-league/equipos') }}"><span>Equipos</span></a></li>
					<li><a href="{{ url('buenos-aires/premier-league/fixture') }}"><span>Fixture</span></a></li>
					<li><a href="{{ url('buenos-aires/premier-league/posiciones') }}"><span>Posiciones</span></a></li>
				</ul>
			</li>
			<li>
				<a href="#"><span>Serie B</span></a>
				<ul>
					<li><a href="{{ url('buenos-aires/serie-b/equipos') }}"><span>Equipos</span></a></li>
					<li><a href="{{ url('buenos-aires/serie-b/fixture') }}"><span>Fixture</span></a></li>
					<li><a href="{{ url('buenos-aires/serie-b/posiciones') }}"><span>Posiciones</span></a></li>
				</ul>
			</li>
			<li>
				<a href="#"><span>Serie C</span></a>
				<ul>
					<li><a href="{{ url('buenos-aires/serie-c/equipos') }}"><span>Equipos</span></a></li>
					<li><a href="{{ url('buenos-aires/serie-c/fixture') }}"><span>Fixture</span></a></li>
					<li><a href="{{ url('buenos-aires/serie-c/posiciones') }}"><span>Posiciones</span></a></li>
				</ul>
			</li>
		</ul>
	</nav>
...
@section('content')
	<!-- PAGE TITLE -->
	<div class="page-title">Buenos Aires</div>
